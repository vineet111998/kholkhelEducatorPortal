...
export default function FormDialog(data) {
  ...
  const handleClose = (event) => {
    let gameData = { game_type_id: data.primaryId, game_attr: data.QuizData, game_artifact: artifactData, game_answer_status: checked, game_desc: name,master_game_type_id:data.masterId,status_id:0};
